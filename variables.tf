...
variable "vpc_name" {
  type        = string
  description = "Name of VPC meant to house database"
}

variable "vpc_cidr" {
default = "10.0.0.0/16"
  type        = string
  description = "CIDR range of VPC meant to house database"
}
...
variable "remote_tf_state" {
  type        = string
  description = "Remote tf state file location"
}
...
variable "remote_tf_state_key" {
  type        = string
  description = "Backend tf state key path"
}